...
PATCH_NAME="patch2_regional_restaurant_dataset_fix"
...
TARGET_FILE="app/db/seed_real_wolfville.py"

if [ -f "$TARGET_FILE" ]; then
  mkdir -p "${BACKUP_DIR}/app/db"
...
SEED_VERSION = "patch2-regional-50-v2"
...
NEW_MINAS_RESTAURANTS: list[RestaurantSeed] = [
    ...
    RestaurantSeed(
        ...
        description="Roadside family-friendly restaurant in New Minas serving breakfast-style, lunch, dinner, and all-day casual meals.",
        town="New Minas",
        category="restaurant",
...
HANTSPORT_AND_AREA_RESTAURANTS: list[RestaurantSeed] = [
    RestaurantSeed(
        name="Glooscap Restaurant & Lounge",
        description="Hantsport casual restaurant and lounge suited to local meals and small-town dining.",
        town="Hantsport",
        category="restaurant",
        subcategory="lounge restaurant",
        source_url="https://www.yellowpages.ca/bus/Nova-Scotia/Hantsport/Glooscap-Restaurant-Lounge/4255720.html",
        price_tier="$$",
        atmosphere="casual",
        pace="moderate",
        social_style="friends",
        ...
        source_notes="Public listings identify Glooscap Restaurant & Lounge in Hantsport.",
    ),
    RestaurantSeed(
        name="Fundy View Restaurant",
        description="Hantsport-area casual restaurant oriented to traditional meals and local visitors.",
        town="Hantsport",
        category="restaurant",
        subcategory="family restaurant",
        source_url="https://www.tripadvisor.ca/Restaurants-g499234-Hantsport_Southwest_Nova_Scotia_Nova_Scotia.html",
        price_tier="$$",
        atmosphere="casual",
        pace="moderate",
        social_style="family",
        ...
        source_notes="Public Hantsport restaurant listings include Fundy View Restaurant.",
    ),
]

BERWICK_AND_AREA_RESTAURANTS: list[RestaurantSeed] = [
    RestaurantSeed(
        name="Jonny's Cookhouse",
        description="Berwick-area local restaurant suited to casual meals and comfort-food dining.",
        town="Berwick",
        category="restaurant",
        subcategory="cookhouse",
        source_url="https://www.tripadvisor.ca/Restaurants-g499235-Berwick_Southwest_Nova_Scotia_Nova_Scotia.html",
        price_tier="$$",
        ...
        source_notes="Public Berwick restaurant listings include Jonny's Cookhouse.",
    ),
    RestaurantSeed(
        name="Chris's Pizza Berwick",
        description="Berwick pizza shop suited to takeout and quick casual dinners.",
        town="Berwick",
        category="fast food",
        subcategory="pizza",
        source_url="https://www.yellowpages.ca/search/si/1/pizza/Berwick+NS",
        price_tier="$",
        ...
        source_notes="Public Berwick business listings identify Chris's Pizza.",
    ),
]
...
RESTAURANTS: list[RestaurantSeed] = (
    ...
    + HANTSPORT_AND_AREA_RESTAURANTS
    + BERWICK_AND_AREA_RESTAURANTS
)
...
echo "Running full restaurant reset + reseed..."
"${PYTHON_BIN}" app/db/reset_and_seed_restaurants.py

echo "Patch 2 fix applied successfully."
