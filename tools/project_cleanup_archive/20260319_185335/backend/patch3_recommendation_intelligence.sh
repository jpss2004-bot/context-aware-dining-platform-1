...
PATCH_NAME="patch3_recommendation_intelligence"
...
class BuildYourNightRequest(BaseModel):
    ...
    # Patch 3 additive filters for richer recommendation-readiness
...
class RecommendationResponse(BaseModel):
    mode: str
    engine_version: str = "phase3-intelligence-v1"
    generated_at: str
...
class RecommendationService:
    ...
    def build_your_night(self, user: User, payload: BuildYourNightRequest) -> RecommendationResponse:
        ...
        ranked = self._score_restaurants(
            ...
            student_friendly=payload.student_friendly,
            date_night=payload.date_night,
            quick_bite=payload.quick_bite,
            fast_food=payload.fast_food,
            requires_dine_in=payload.requires_dine_in,
            requires_takeout=payload.requires_takeout,
            requires_delivery=payload.requires_delivery,
            requires_reservations=payload.requires_reservations,
            requires_live_music=payload.requires_live_music,
            requires_trivia=payload.requires_trivia,
            include_dish_hints=payload.include_dish_hints,
        )
...
echo "Patch 3 files written successfully."

echo "Running import smoke test..."
PYTHONPATH=. "${PYTHON_BIN}" - <<'PY'
from app.services.recommendation_service import RecommendationService
from app.schemas.recommendation import BuildYourNightRequest
print("RecommendationService import OK")
print("BuildYourNightRequest import OK")
PY
